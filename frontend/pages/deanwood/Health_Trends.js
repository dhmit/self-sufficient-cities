...
export default function HealthTrends() {
    ...
    const handleChange = (e) => {
        ...
        case "healthcare":
            ...
            setDescription("The number of people who have asthma in a region can be associated with air\n" +
                "quality in that respective region, whereby the more the people with asthma in a \n" +
                "region then the poor the air quality in that region because asthma and asthma \n" +
                "attacks are associated with secondhand smoke,traffic pollution and poor housing \n" +
                "conditions among other factors thus from the above data,it can be inferred that \n" +
                "Deanwood’s air quality may be low than the the D.C average air quality and even \n" +
        ...
        case "air_quality":
            ...
            setDescription("We will use the Canvas website for announcements, class material, problem sets, and for\n" +
                "the course calendar.\n" +
        ...
        case "diabetes":
            ...
            setDescription("Access to Early Prenatal Care is among the factors that indicate the quality of \n" +
                "healthcare services and ease of access to such services in different areas and \n" +
                "from the above data,It can be inferred that Deanwood(Ward 7) has yet to have a\n" +
                " satisfiable percentage of women who received early prenatal care in the recent \n" +
            ...
            setDescription(" In the beginning of the pandemic,the number of people who were affected\n" +
