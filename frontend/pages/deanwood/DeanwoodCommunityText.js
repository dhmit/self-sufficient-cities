...
export const quotes = [
    <blockquote key="quote-taylor">&#8220;You see you go back in those days- I don’t know, people
        came out of schools, I think, a little better prepared. I am not one of those to say, ‘The
        good ole days,’ because they were hard days, but I think they had a better
        background.&#8221;- Mr. McKinley Taylor, 1975
    </blockquote>,
    <blockquote key="quote-greene">&#8220;But I grew up in a community where there
        were <mark>doctors</mark> on my street,
        there were <mark> lawyers</mark> on my street, there were <mark>schoolteachers</mark> on
        my street, there were people of varying economic status, where <mark>we could make up
            our minds</mark>...But what do these kids have to aspire to in a great big low rent
        ghetto with the same thing every day?&#8221;- Mrs. Ethel G Greene 1975
    </blockquote>,
    <blockquote key="quote-blake">&#8220;The races just stayed together; to themselves,
        and didn’t bother each other at all. <mark>There were no conflicts. Everybody just lived
            their own life.</mark> Nobody bothered anyone else.&#8221; - Anita B Blake 1975
    </blockquote>,
    <blockquote key="quote-blake-1">&#8220;Well everything centered around the home, individual
        home life and yet a fine community spirit. Everybody was interested in the needs of
        the other whether they were able to help other than physically or not.&#8221; - Anita B
        Blake 1975</blockquote>,
    <blockquote key="quote-dale">&#8220;I think that the average black person back there in those
        days when I was a child was just so frustrated that it was <mark>so ground into him that
            you’re
            just nobody and you don’t expect to get but so much</mark>. That’s really the
        situation.&#8221; -
        Norman Dale 1975</blockquote>,
    <blockquote key="quote-taylor-1">&#8220;Most of [the blacks were close to each other].
        <mark>You didn’t have the turmoil that we have now.</mark>&#8221;
        - Mr. McKinley Taylor, 1975</blockquote>,
    <blockquote key="quote-greene-1">&#8220;It always disturbs me though that people think that
        Anacostia is nothing but cut-throats, thieves, robbers and murderers. When you look back
        historically, you see that...we certainly have been good citizens, and we tried to live
        representative lives...There is no more beautiful sight than Anacostia.&#8221;- Mrs. Ethel
        G Greene, 1975
    </blockquote>,
    <blockquote key="quote-smith">&#8220;The ideals of Nannie Helen Boroughs is about <mark>
        self-reliance and economic development</mark>.&#8221;- Bailey Smith 2020"</blockquote>];

export const quoteContext = [
    "Most of these quotes come from former Deanwood residents in 1975" +
    ...
    "The quotes were collected by the Anacostia Oral Histories project in 1975, just two years " +
    "after Congress passed the Home Rule Act of 1973. The Act allowed the residents of the " +
    "District of Columbia to self-govern and elect a mayor and city council.",
    <a key="2"
       className={"citation-pointer"}
       title="D.C. Home Rule"
       href={"#source-2"}>[2]</a>,
    "Before, DC, and by extension Deanwood, was governed by Congress. Appointed officials, " +
    "separated from the realities of living in Deanwood, made the decisions about day-to-day " +
    "life there. The Oral Histories project asked many questions in their interviews, but they " +
    "all served to ask this fundamental question of the residents: 'How did you manage " +
    "on your own for so many decades?'",
...
export const uniqueDeanwood = "But what made Deanwood so unique from other neighborhoods " +
    "that it thrived in these conditions?";

export const infrastructure1 = [
    "Greenspace was hard to come by. White people in DC had access to" +
    " on average 2.45 times as many playgrounds as DC’s black residents in 1929.",
    <a key="3"
       className={"citation-pointer"}
       title="18th annual report"
       href={"#source-3"}>[3]</a>, "Residents often fondly remembered two private parks, Eureka and Greenwillow, " +
    "that local entrepreneurs built for black residents to relax and come together as " +
    "an alternative to the paid parks they were offered by the city. Their white counterparts " +
    "had free public parks.",
    "The Glen Echo amusement park along the Potomac River was only accessible to white people, " +
    "so Lewis Giles Sr, a black architect, helped to design Suburban Gardens, a" +
...
export const senatorTaxesQuote = <blockquote>&#8220;The Senator had told him, 'You don’t need
    water, you don’t need sidewalks, you don’t need these things, because if you get them it will
    increase your taxes'&#8221;- Mrs. Ethel G Greene 1975</blockquote>;
...
export const lifesaverQuote = <blockquote>
    ...
    the grocery store away.’</mark><a key="6" className={"citation-pointer"}
                                      title="Black-owned Grocery Chain"
                                      href={"#source-6"}>[6]</a></blockquote>;
...
"a smaller role in people’s lives, one can argue that some factor stripped Deanwood of its" +
